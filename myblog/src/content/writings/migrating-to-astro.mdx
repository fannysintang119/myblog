...
I use Astro as a static site generator, so deployment works the same way as Hugo. This site is hosted on [Cloudflare Pages](https://pages.cloudflare.com/), I just connected the GitHub repo to it and set the build command to `npm run build` and voilà! 🎉
